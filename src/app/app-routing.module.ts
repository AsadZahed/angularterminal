...
//terminal route step-2
import { TerminalRouteComponent } from './components/terminal-route/terminal-route.component';
...
//route path for terminal-route step-3
{ 
  path: 'viewEmployeeLeaves',
